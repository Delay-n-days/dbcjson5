//*********************************** 宏定义 *********************************************//
//*********************************** CAN通讯接收数据帧个数 *********************************************//
#define SAE_MAX_RX_NUM  		0

//*********************************** CAN通讯发送数据帧个数 *******************************************//
#define SAE_MAX_TX_NUM  		5	//注意此处为协议定义发送个数,不用预留
...
//*********************************** CAN通讯波特率设置 ***********************************************//
#define BAUD250					0   // 0:无效 1:250K波特率
#define BAUD500					1   // 0:无效 1:500K波特率

//******************************CAN通讯接收帧ID*******************************************//
#define CAN_ID_MSG1 			((unsigned long)0x0CFF05EF)	// 接收VCU帧ID,ID=0x0CFF05EF
#define CAN_ID_MSG2 			((unsigned long)0x18FF50E5)	// 接收VCU帧ID,ID=0x18FF50E5

//*************************** CAN通讯发送数据帧周期(单位ms)*******************************//
#define MCUMSGTX0TIME			10	//报文发送周期
#define MCUMSGTX1TIME			10	//报文发送周期
#define MCUMSGTX2TIME			50	//报文发送周期
#define MCUMSGTX3TIME			100	//报文发送周期
#define MCUMSGTX4TIME			100	//报文发送周期

//*************************** CAN通讯数据帧结构体定义 ************************************//
// 发送报文1：TM_HCU_Command
// ID = 0x0CFF09EF
// T=10ms
...
// 发送报文5：TM_MCU_Status4
// ID = 0x0CFF0309
// T=100ms
typedef struct __MOTOR_TX5
{
    // Byte0 ---------------------------------------------------
...
typedef union __SAE_DATA
{
	...
	SAE_Bytes Bytes;
	TYPE_MOT_TX1 MotTx1; // TM_HCU_Command
	TYPE_MOT_TX2 MotTx2; // TM_MCU_Status1
	TYPE_MOT_TX3 MotTx3; // TM_MCU_Status2
	TYPE_MOT_TX4 MotTx4; // TM_MCU_Status3
	TYPE_MOT_TX5 MotTx5; // TM_MCU_Status4
}SAE_DATA;
