...
//******************************CAN通讯接收帧ID*******************************************//
#define CAN_ID_MSG1 			((unsigned long)0x0CFF0309)	// 接收VCU帧ID,ID=0x0CFF0309
#define CAN_ID_MSG2 			((unsigned long)0x0CFF0309)	// 接收VCU帧ID,ID=0x0CFF0309
...
typedef union __SAE_DATA
{
	...
	TYPE_MOT_TX1 MotTx1; // TM_MCU_Status1
	TYPE_MOT_TX2 MotTx2; // TM_MCU_Status2
	TYPE_MOT_TX3 MotTx3; // TM_MCU_Status3
	TYPE_MOT_TX4 MotTx4; // TM_MCU_Status4
}SAE_DATA;
